...
//    	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
    ...
    public void clicks_reconcile_cash_office() throws Throwable {
        // checks if office is already open and reconciles to enable it to be opened again
        Thread.sleep(4000);
        WebElement reconcileCashofficeButton = driver.findElement(By.id("CashOfficeDailyControlform:btnReconcileCashOffice"));
        if (!reconcileCashofficeButton.isEnabled()) {
            driver.findElement(By.id("CashOfficeDailyControlform:btnOpenCashOffice")).click();
            driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
            driver.findElement(By.xpath("//*[@id=\"CashOfficeDailyControlform:growl\"]/div/a")).click();
        }
        Thread.sleep(2000);
    ...
    public void system_displays_message_records_not_found() throws Throwable {
        ...
        WebElement Message = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"SearchForm:resultsDataTable_data\"]/tr/td")));
        if (Message.isDisplayed()) {
            Assert.assertTrue("Success message displayed", true);
        } else {
            Assert.fail("No Success message displayed");
    ...
    public void payment_summary_window_displayed(String tin) throws Throwable {
        WebDriverWait wait = new WebDriverWait(driver, 30);
        WebElement paymentSummary = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("PaymentSummary:TIN")));

        Assert.assertTrue(paymentSummary.isDisplayed());
//        String paymentSummaryLabel = paymentSummary.getText();
//        Assert.assertEquals(tin,paymentSummaryLabel);
    ...
    public void payment_details_should_be_displayed() throws Throwable {
        WebDriverWait wait = new WebDriverWait(driver, 30);
        WebElement paymentDetails = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"PaymentDetails:paymentAccordion\"]/ul/li")));
        String paymentDetailsHeader = paymentDetails.getText();
...
//        driver.findElement(By.id("ReceiptDocumentControl:CashOfficeDD_1")).click();
    ...
    @When("^clicks Payment Report \"([^\"]*)\"$")
    public void clicks_payment_report_something(String strArg1) throws Throwable {

        WebElement report = driver.findElement(By.xpath("//a[contains(text(),'" + strArg1 + "')]"));
...
//        Assert.assertEquals(reportName, reportname);
    ...
    public void searched_results_should_be_displayed_in_a_table() throws Throwable {
        WebDriverWait wait = new WebDriverWait(driver, 30);
        WebElement firstRow = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"SearchForm:resultsDataTable_data\"]/tr[1]")));
    ...
    public void user_clicks_taxpayers_payment_to_be_reversed() throws Throwable {
        WebDriverWait wait = new WebDriverWait(driver, 30);
        WebElement firstRow = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"SearchForm:resultsDataTable_data\"]/tr[2]/td[1]")));
        firstRow.click();
    ...
    public void clicks_reverse_button() throws Throwable {
        ...
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", reverseButton);
        Thread.sleep(500);
    ...
    public void no_records_found() throws Throwable {
        Thread.sleep(5000);
        String emptyDatatable = driver.findElement(By.xpath("//*[@id=\"SearchForm:resultsDataTable_data\"]/tr")).getText();
        Assert.assertEquals("No record(s) found.", emptyDatatable);
    }
    ...
    public void navigate_to_my_taxmake_payment() throws Throwable {
        WebDriverWait wait = new WebDriverWait(driver, 30);
        WebElement id_btn = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("id_btnMyTaxToggle")));
        id_btn.click();
    ...
    public void outstanding_payments_list_screen_should_be_displayed() throws Throwable {
        WebDriverWait wait = new WebDriverWait(driver, 30);
        WebElement success = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("id_outstandingPaymentForm")));
        String header = success.getText();
    ...
    public void selects_the_tax_type_liability_to_be_paid() throws Throwable {
        WebDriverWait wait = new WebDriverWait(driver, 30);
        WebElement taxTaypeChosen = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/trips-app/div/ng-component/div/app-revenue-collection/app-outstanding-payment-list/div/div[2]/p-table/div/div[1]/table/tbody/tr/td[8]/span[2]/div/p-tablecheckbox/div/div[2]")));
    ...
    public void confirmation_and_payment_ref_number_is_shown() throws Throwable {
        WebDriverWait wait = new WebDriverWait(driver, 30);
        WebElement success = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/trips-app/div/ng-component/div/app-revenue-collection/ng-component/div/div/h3")));
        if (success.isDisplayed()) {
            Assert.assertTrue("Your Payment Reference Number (PRN) is:", true);
        } else {
